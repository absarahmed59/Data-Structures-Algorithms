...
class bomber{
	...
	public:
		...
		void connection(){
			...
			axis[0][0]->right = axis[0][1];		axis[0][0]->down = axis[1][0];	axis[0][0]->left = NULL;			axis[0][1]->up = NULL;
			axis[0][1]->right = axis[0][2];		axis[0][1]->down = axis[1][1];	axis[0][1]->left = axis[0][0];		axis[0][1]->up = NULL;
			axis[0][2]->right = axis[0][3];		axis[0][2]->down = axis[1][2];	axis[0][2]->left = axis[0][1];		axis[0][2]->up = NULL;
			axis[0][3]->right = axis[0][4];		axis[0][3]->down = axis[1][3];	axis[0][3]->left = axis[0][2];		axis[0][3]->up = NULL;
			...
			axis[1][0]->right = axis[1][1]; 	axis[1][0]->down = axis[2][0];	axis[1][0]->left = NULL;			axis[1][0]->up = axis[0][0];
			axis[1][1]->right = axis[1][2];		axis[1][1]->down = axis[2][1];	axis[1][1]->left = axis[1][0];		axis[1][1]->up = axis[0][1];
			axis[1][2]->right = axis[1][3];		axis[1][2]->down = axis[2][2];	axis[1][2]->left = axis[1][1];		axis[1][2]->up = axis[0][2];
			axis[1][3]->right = axis[1][4];		axis[1][3]->down = axis[2][3];	axis[1][3]->left = axis[1][2];		axis[1][3]->up = axis[0][3];
			axis[1][4]->right = axis[1][5];		axis[1][4]->down = axis[2][4];	axis[1][4]->left = axis[1][3];		axis[1][4]->up = axis[0][4];
			axis[1][5]->right = axis[1][6];		axis[1][5]->down = axis[2][5];	axis[1][5]->left = axis[1][4];		axis[1][5]->up = axis[0][5];
			axis[1][6]->right = axis[1][7];		axis[1][6]->down = axis[2][6];	axis[1][6]->left = axis[1][5];		axis[1][6]->up = axis[0][6];
			...
			axis[2][1]->right = axis[2][2];		axis[2][1]->down = axis[3][1];	axis[2][1]->left = axis[2][0];		axis[2][1]->up = axis[1][1];
			axis[2][2]->right = axis[2][3];		axis[2][2]->down = axis[3][2];	axis[2][2]->left = axis[2][1];		axis[2][2]->up = axis[1][2];
			axis[2][3]->right = axis[2][4];		axis[2][3]->down = axis[3][3];	axis[2][3]->left = axis[2][2];		axis[2][3]->up = axis[1][3];
			axis[2][4]->right = axis[2][5];		axis[2][4]->down = axis[3][4];	axis[2][4]->left = axis[2][3];		axis[2][4]->up = axis[1][4];
			axis[2][5]->right = axis[2][6];		axis[2][5]->down = axis[3][5];	axis[2][5]->left = axis[2][4];		axis[2][5]->up = axis[1][5];
			axis[2][6]->right = axis[2][7];		axis[2][6]->down = axis[3][6];	axis[2][6]->left = axis[2][5];		axis[2][6]->up = axis[1][6];
			axis[2][7]->right = axis[2][8];		axis[2][7]->down = axis[3][7];	axis[2][7]->left = axis[2][6];		axis[2][7]->up = axis[1][7];
			...
			axis[3][0]->right = axis[3][1]; 	axis[3][0]->down = axis[4][0];	axis[3][0]->left = NULL;			axis[3][0]->up = axis[2][0];
			...
			axis[3][3]->right = axis[3][4];		axis[3][3]->down = axis[4][3];	axis[3][3]->left = axis[3][2];		axis[3][3]->up = axis[2][3];
			axis[3][4]->right = axis[3][5];		axis[3][4]->down = axis[4][4];	axis[3][4]->left = axis[3][3];		axis[3][4]->up = axis[2][4];
			axis[3][5]->right = axis[3][6];		axis[3][5]->down = axis[4][5];	axis[3][5]->left = axis[3][4];		axis[3][5]->up = axis[2][5];
			axis[3][6]->right = axis[3][7];		axis[3][6]->down = axis[4][6];	axis[3][6]->left = axis[3][5];		axis[3][6]->up = axis[2][6];
			...
			axis[4][2]->right = axis[4][3];		axis[4][2]->down = axis[5][2];	axis[4][2]->left = axis[4][1];		axis[4][2]->up = axis[3][2];
			axis[4][3]->right = axis[4][4];		axis[4][3]->down = axis[5][3];	axis[4][3]->left = axis[4][2];		axis[4][3]->up = axis[3][3];
			axis[4][4]->right = axis[4][5];		axis[4][4]->down = axis[5][4];	axis[4][4]->left = axis[4][3];		axis[4][4]->up = axis[3][4];
			axis[4][5]->right = axis[4][6];		axis[4][5]->down = axis[5][5];	axis[4][5]->left = axis[4][4];		axis[4][5]->up = axis[3][5];
			axis[4][6]->right = axis[4][7];		axis[4][6]->down = axis[5][6];	axis[4][6]->left = axis[4][5];		axis[4][6]->up = axis[3][6];
			...
			axis[5][1]->right = axis[5][2];		axis[5][1]->down = axis[6][1];	axis[5][1]->left = axis[5][0];		axis[5][1]->up = axis[4][1];
			axis[5][2]->right = axis[5][3];		axis[5][2]->down = axis[6][2];	axis[5][2]->left = axis[5][1];		axis[5][2]->up = axis[4][2];
			axis[5][3]->right = axis[5][4];		axis[5][3]->down = axis[6][3];	axis[5][3]->left = axis[5][2];		axis[5][3]->up = axis[4][3];
			axis[5][4]->right = axis[5][5];		axis[5][4]->down = axis[6][4];	axis[5][4]->left = axis[5][3];		axis[5][4]->up = axis[4][4];
			axis[5][5]->right = axis[5][6];		axis[5][5]->down = axis[6][5];	axis[5][5]->left = axis[5][4];		axis[5][5]->up = axis[4][5];
			axis[5][6]->right = axis[5][7];		axis[5][6]->down = axis[6][6];	axis[5][6]->left = axis[5][5];		axis[5][6]->up = axis[4][6];
			axis[5][7]->right = axis[5][8];		axis[5][7]->down = axis[6][7];	axis[5][7]->left = axis[5][6];		axis[5][7]->up = axis[4][7];
			...
			axis[6][2]->right = axis[6][3];		axis[6][2]->down = axis[7][2];	axis[6][2]->left = axis[6][1];		axis[6][2]->up = axis[5][2];
			axis[6][3]->right = axis[6][4];		axis[6][3]->down = axis[7][3];	axis[6][3]->left = axis[6][2];		axis[6][3]->up = axis[5][3];
			axis[6][4]->right = axis[6][5];		axis[6][4]->down = axis[7][4];	axis[6][4]->left = axis[6][3];		axis[6][4]->up = axis[5][4];
			axis[6][5]->right = axis[6][6];		axis[6][5]->down = axis[7][5];	axis[6][5]->left = axis[6][4];		axis[6][5]->up = axis[5][5];
			axis[6][6]->right = axis[6][7];		axis[6][6]->down = axis[7][6];	axis[6][6]->left = axis[6][5];		axis[6][6]->up = axis[5][6];
			axis[6][7]->right = axis[6][8];		axis[6][7]->down = axis[7][7];	axis[6][7]->left = axis[6][6];		axis[6][7]->up = axis[5][7];
			axis[6][8]->right = axis[6][9];		axis[6][8]->down = axis[7][8];	axis[6][8]->left = axis[6][7];		axis[6][8]->up = axis[5][8];
			...
			axis[7][3]->right = axis[7][4];		axis[7][3]->down = axis[8][3];	axis[7][3]->left = axis[7][2];		axis[7][3]->up = axis[6][3];
			axis[7][4]->right = axis[7][5];		axis[7][4]->down = axis[8][4];	axis[7][4]->left = axis[7][3];		axis[7][4]->up = axis[6][4];
			axis[7][5]->right = axis[7][6];		axis[7][5]->down = axis[8][5];	axis[7][5]->left = axis[7][4];		axis[7][5]->up = axis[6][5];
			axis[7][6]->right = axis[7][7];		axis[7][6]->down = axis[8][6];	axis[7][6]->left = axis[7][5];		axis[7][6]->up = axis[6][6];
			axis[7][7]->right = axis[7][8];		axis[7][7]->down = axis[8][7];	axis[7][7]->left = axis[7][6];		axis[7][7]->up = axis[6][7];
			axis[7][8]->right = axis[7][9];		axis[7][8]->down = axis[8][8];	axis[7][8]->left = axis[7][7];		axis[7][8]->up = axis[6][8];
			axis[7][9]->right = NULL;			axis[7][9]->down = axis[8][9];	axis[7][9]->left = axis[7][8];		axis[7][9]->up = axis[6][9];
			...
			axis[8][4]->right = axis[8][5];		axis[8][4]->down = axis[9][4];	axis[8][4]->left = axis[8][3];		axis[8][4]->up = axis[7][4];
			...
			axis[8][8]->right = axis[8][9];		axis[8][8]->down = axis[9][8];	axis[8][8]->left = axis[8][7];		axis[8][8]->up = axis[7][8];
		...
		void populating(){
			...
			axis[0][0]->data=w;axis[1][0]->data=d;axis[2][0]->data=d;axis[3][0]->data=d;axis[4][0]->data=w;axis[5][0]->data=d;axis[6][0]->data=w;axis[7][0]->data=d;axis[8][0]->data=d;axis[9][0]->data=d;
			axis[0][1]->data=w;axis[1][1]->data=d;axis[2][1]->data=d;axis[3][1]->data=d;axis[4][1]->data=w;axis[5][1]->data=d;axis[6][1]->data=d;axis[7][1]->data=d;axis[8][1]->data=d;axis[9][1]->data=w;
			axis[0][2]->data=d;axis[1][2]->data=d;axis[2][2]->data=d;axis[3][2]->data=d;axis[4][2]->data=d;axis[5][2]->data=d;axis[6][2]->data=d;axis[7][2]->data=d;axis[8][2]->data=d;axis[9][2]->data=d;
			axis[0][3]->data=d;axis[1][3]->data=w;axis[2][3]->data=w;axis[3][3]->data=d;axis[4][3]->data=d;axis[5][3]->data=d;axis[6][3]->data=d;axis[7][3]->data=d;axis[8][3]->data=w;axis[9][3]->data=d;
			axis[0][4]->data=s;axis[1][4]->data=w;axis[2][4]->data=w;axis[3][4]->data=d;axis[4][4]->data=d;axis[5][4]->data=d;axis[6][4]->data=w;axis[7][4]->data=d;axis[8][4]->data=w;axis[9][4]->data=d;
			axis[0][5]->data=s;axis[1][5]->data=d;axis[2][5]->data=w;axis[3][5]->data=w;axis[4][5]->data=d;axis[5][5]->data=w;axis[6][5]->data=w;axis[7][5]->data=d;axis[8][5]->data=d;axis[9][5]->data=d;
			axis[0][6]->data=s;axis[1][6]->data=d;axis[2][6]->data=d;axis[3][6]->data=d;axis[4][6]->data=d;axis[5][6]->data=d;axis[6][6]->data=d;axis[7][6]->data=d;axis[8][6]->data=d;axis[9][6]->data=d;
			axis[0][7]->data=d;axis[1][7]->data=d;axis[2][7]->data=d;axis[3][7]->data=w;axis[4][7]->data=w;axis[5][7]->data=d;axis[6][7]->data=d;axis[7][7]->data=d;axis[8][7]->data=d;axis[9][7]->data=d;
			axis[0][8]->data=d;axis[1][8]->data=d;axis[2][8]->data=d;axis[3][8]->data=d;axis[4][8]->data=d;axis[5][8]->data=d;axis[6][8]->data=d;axis[7][8]->data=w;axis[8][8]->data=d;axis[9][8]->data=w;
			axis[0][9]->data=w;axis[1][9]->data=d;axis[2][9]->data=d;axis[3][9]->data=d;axis[4][9]->data=w;axis[5][9]->data=w;axis[6][9]->data=d;axis[7][9]->data=w;axis[8][9]->data=d;axis[9][9]->data=d;
			face = axis[0][4];
			face->data = f;
		}
		void maze(){
		...
		void key_counter(){
			...
			cout<<endl<<endl<<endl<<"Keys: "<<c;
			k = getch();
		}
		void key_collector(){
			if(k=='a'&&face->left->data=="&&"&&face->left == axis[0][2]){
					face->data=s;
					face=face->left;
					face->data = f;
					key[0]=1;
				...
				else if(k=='d'&&face->right->data=="&&"&&face->right == axis[0][2]){
					face->data=s;
					face=face->right;
					face->data = f;
					key[0]=1;
				...
				else if(k=='w'&&face->up->data=="&&"&&face->up == axis[0][2]){
					face->data=s;
					face=face->up;
					face->data = f;
					key[0]=1;
				...
				else if(k=='s'&&face->down->data=="&&"&&face->down == axis[0][2]){
					face->data=s;
					face=face->down;
					face->data = f;
					key[0]=1;
				...
				if(k=='a'&&face->left->data=="&&"&&face->left == axis[5][4]){
					face->data=s;
					face=face->left;
					face->data = f;
					key[1] = 1;
				...
				else if(k=='d'&&face->right->data=="&&"&&face->right == axis[5][4]){
					face->data=s;
					face=face->right;
					face->data = f;
					key[1] = 1;
				...
				else if(k=='w'&&face->up->data=="&&"&&face->up == axis[5][4]){
					face->data=s;
					face=face->up;
					face->data = f;
					key[1] = 1;
				...
				else if(k=='s'&&face->down->data=="&&"&&face->down == axis[5][4]){
					face->data=s;
					face=face->down;
					face->data = f;
					key[1] = 1;
				...
				if(k=='a'&&face->left->data=="&&"&&face->left == axis[9][2]){
					face->data=s;
					face=face->left;
					face->data = f;
					key[2]=1;
				...
				else if(k=='d'&&face->right->data=="&&"&&face->right == axis[0][9]){
					face->data=s;
					face=face->right;
					face->data = f;
					key[2]=1;
				...
				else if(k=='w'&&face->up->data=="&&"&&face->up == axis[9][2]){
					face->data=s;
					face=face->up;
					face->data = f;
					key[2]=1;
				...
				else if(k=='s'&&face->down->data=="&&"&&face->down == axis[9][2]){
					face->data=s;
					face=face->down;
					face->data = f;
					key[2]=1;
		...
		void face_movement(){
			if(k=='a'&&face->left!=NULL&&face->left->data!="MM"&&face->left->data!="||"&&face->left->data!=b){
					face->data=s;
					face=face->left;
					face->data = f;
				}
				else if(k=='d'&&face->right!=NULL&&face->right->data!="MM"&&face->right->data!="||"&&face->right->data!=b){
					face->data=s;
					face=face->right;
					face->data = f;
				}
				else if(k=='w'&&face->up!=NULL&&face->up->data!="MM"&&face->up->data!="||"&&face->up->data!=b){
					face->data=s;
					face=face->up;
					face->data = f;
				}
				else if(k=='s'&&face->down!=NULL&&face->down->data!="MM"&&face->down->data!="||"&&face->down->data!=b){
					face->data=s;
					face=face->down;
					face->data = f;
				}
		...
		void bombing(){
			if(k == 'b'){
					...
					bomb->data = b;
					if(face->left!=NULL){
						if(face->left == axis[0][2]&&key[0]!=1)
							face->left->data = keyy;
						if(face->left == axis[5][4]&&key[1]!=1)
							face->left->data = keyy;
						if(face->left == axis[9][2]&&key[2]!=1)
							face->left->data = keyy;
					}
					if(face->up!=NULL){
						if(face->up == axis[0][2]&&key[0]!=1)
							face->up->data = keyy;
						if(face->up == axis[5][4]&&key[1]!=1)
							face->up->data = keyy;
						if(face->up == axis[9][2]&&key[2]!=1)
							face->up->data = keyy;
					}
					if(face->down!=NULL){
						if(face->down == axis[0][2]&&key[0]!=1)
							face->down->data = keyy;
						if(face->down == axis[5][4]&&key[1]!=1)
							face->down->data = keyy;
						if(face->down == axis[9][2]&&key[2]!=1)
							face->down->data = keyy;
					}
					if(face->right!=NULL){
						if(face->right == axis[0][2]&&key[0]!=1)
							face->right->data = keyy;
						if(face->right == axis[5][4]&&key[1]!=1)
							face->right->data = keyy;
						if(face->right == axis[9][2]&&key[2]!=1)
							face->right->data = keyy;
					}
				}
		}
		void timer_loss(){
			if(t>2){					
					...
					if(bomb->left == face || bomb->right == face || bomb->right == face || bomb->up == face){
						cout<<"\n\t\tYou Lost"<<endl;
						exit(0);
					}
					else{
